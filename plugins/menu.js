 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
   ...
   const sections = [
   {
	...
	rows: [
	    {title: `🌎 ${pmenus} 𝙶𝚁𝙾𝚄𝙿 𝚂𝚃𝙾𝚁𝙴`, rowId: ".komu", description: "𝙼𝚎𝚗𝚊𝚖𝚙𝚒𝚕𝚔𝚊𝚗 𝙻𝚒𝚗𝚔 𝙶𝚛𝚘𝚞𝚙"},
...
//-------DOC TEMPLATE
            ...
            templateButtons: [
                {
                    urlButton: {
                        displayText: `${namebot}`,
                        url: 'https://github.com/AinulStore'
                    }
                },
                {
                    urlButton: {
    ...
    //------------------- 2BUTTON VID
   // conn.sendMessage(m.chat, { video: { url: 'https://telegra.ph/file/c82d5c358495e8ef15916.mp4' }, gifPlayback: true, gifAttribution: ~~(Math.random() * 2), caption: text.trim(), footer: 'ᴍᴀᴅᴇ ᴡɪᴛʜ ❤ ʙʏ Ainul', templateButtons: [{ quickReplyButton: { displayText: 'Speedtest⚡', id: `${_p}speedtest` }}, { quickReplyButton: { displayText: 'Owner🎀', id: `${_p}owner` }} ] })
